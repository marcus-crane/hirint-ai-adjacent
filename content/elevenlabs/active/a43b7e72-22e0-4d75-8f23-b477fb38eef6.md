...
This role is remote-first, so it can be executed from anywhere in Brazil, with a preference of Sao Paolo. Expect regular travel for customer onsite. Fluency in English and Portuguese and a deep understanding of the regional and cultural nuances is required.
