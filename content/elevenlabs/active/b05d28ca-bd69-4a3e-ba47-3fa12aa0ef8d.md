...
* Drive the development of innovative features in our mobile projects through using a combination of data analysis, product ideation, and experimentation to optimize user experiences.
* Plan and deploy mobile platform infrastructure necessary to build, test, and deploy these product experiences.
* Collaborate closely with design, product, research teams to achieve product goals.
