---
title: Technical Program Coordinator, DDMR, London
status: active
id: '5991428004'
source: greenhouse
url: https://job-boards.greenhouse.io/isomorphiclabs/jobs/5991428004
lastmod: '2026-05-22T11:31:46-04:00'
date: '2026-05-22T11:31:46-04:00'
location: London
departments:
- Drug Design
offices:
...
As part of the ongoing expansion of our Drug Design and Medical Research (DDMR) function, we are looking to recruit a Technical Program Coordinator.

As a member of the Technical Program Management team you will be responsible for facilitating all aspects of program management,  providing hands-on support to our AI-first Drug Design programs. You will work in alignment with the drug design teams in addition to liaising with key internal stakeholders including governance, finance, legal and business development.

If you are an organised, skilled and ambitious individual looking to take the next step in your career, joining Isomorphic Labs now will lift you out of your comfort zone and provide you with an amazing opportunity for personal growth and development.

### **What you will do**

* As a member of the TPM team you will be responsible for supporting DDMR with program planning, dynamically monitoring timelines, action tracking, risk reporting, effective meetings and stakeholder management
* You will manage and monitor program budgets with respect to forecasting and actual spend to support both the program team, DDMR and TPM team
* You will provide help to program teams to effectively liaise with CROs and other external providers/partners,  helping with contract reviews and processing
* This role is positioned in a wider Technical Program Management team so you will help to build and embed processes and operating systems, ensuring integration and alignment across Isolabs

### **Skills and qualifications**

### **Essential:**

* At least a BSc in Biology, Chemistry or related discipline
* Proven industry experience in contributing to, managing or leading early stage small molecule and/or peptide drug design programs
* Understanding of small molecule / peptide drug discovery / development processes in the context of different stakeholders requirements, project planning, governance and finance
* Have experience of operating program management processes
* Experience with program risk management
* Experience supporting teams in fast-paced and constantly changing environments
* Ability to adaptively interact and confidently communicate with diverse key stakeholders
* Patient, organised and detail oriented

### **Nice to have:**

* Experience of managing budgets, including planning, forecasting, monitoring, troubleshooting and working to identify efficiencies
* Program management qualification
* Experience of working in an ML drug discovery environment
* Working with Jira and / or confluence or other program management software
