---
title: Software Engineer (ML Infrastructure), London
status: active
id: '5818858004'
source: greenhouse
url: https://job-boards.greenhouse.io/isomorphiclabs/jobs/5818858004
lastmod: '2026-09-24T11:44:44-04:00'
date: '2026-03-04T08:39:00-05:00'
location: London
departments:
- Tech
offices:
...
This is an exciting opportunity for a small number of innovative and versatile software engineers to work in a fast-paced and research-centric environment.

You will collaborate extensively with internal engineering and research teams to evolve the foundational infrastructure that makes it easy to train and deploy novel machine learning models over vast (and growing) pools of compute and data.

For this role we are looking for individuals with experience of designing and evolving complex systems at significant scale. Domain knowledge of ML inference, training or research infrastructure will be a strong advantage, though we encourage applications from candidates with a record of exceptional impact in any field.

### **What you will do**

* Evolve the ML infrastructure platform to accelerate both human and agent-driven research at scale
* Explore options to deploy agents to increase the robustness and reliability of the platform
* Develop the platform to enable the next generation of distributed, performance-critical training and inference workloads
* Partner closely with engineering, research and product teams to identify and deliver impact

### **Skills and qualifications**

### **Essential:**

* Demonstrated ability to independently identify opportunities, deliver solutions and work effectively in cross-functional teams
* Experience building and evolving infrastructure or platforms at significant scale
* Strong Python programming (though familiarity with any particular library is not required)

### **Nice to have:**

* Domain knowledge of ML inference, training or research infrastructure
* Strong hands-on experience building for Kubernetes
* Experience providing platforms to internal customers
