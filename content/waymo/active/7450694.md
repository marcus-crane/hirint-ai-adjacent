---
title: Staff TLM, Perception, Continuous Learning & Monitoring
status: active
id: '7450694'
source: greenhouse
url: https://careers.withwaymo.com/jobs?gh_jid=7450694
lastmod: '2026-05-28T13:18:09-04:00'
date: '2025-12-09T13:49:16-05:00'
...
* Owned model updates and model deployment in an automated data selection/model update pipeline, for an ML system serving millions of rides
* Lead the design and implementation of data selection and incremental model updates, for a multi-billion parameter model
* Developed and deployed methods for in-field monitoring of deployed ML models, and detect improvements or regressions after a model update, for an ML system serving millions of rides
...
* 2+ year in managing ML engineering or research teams
