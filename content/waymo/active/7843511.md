---
title: Staff Software Engineer, Data-Driven Behaviors
status: active
id: '7843511'
source: greenhouse
url: https://careers.withwaymo.com/jobs?gh_jid=7843511
lastmod: '2026-07-07T13:30:06-04:00'
...
* Lead and develop the data pipelines that power ML solutions for the Waymo driver's decision making and motion planning: spanning data mining from large datasets, refining labeling policies, and shaping the reward or loss functions for ML models
* Quickly prototype ideas to improve data pipelines and conduct model finetuning
* Integrate and deploy ML models on the fleet, conducting end-to-end validation and enabling on-field monitoring
* Collaborate closely with partner teams such as perception, research, simulation, and evaluation
* Mentor engineers in leading adoption of data-primary approaches for solving reasoning problems

**You have:**

* Experience in applied machine learning: data shaping, feature engineering, loss/reward shaping, finetuning and model evaluation
* Eval experience: contributing to scalable eval workflows and building metrics for ML models
* Proficiency in dealing with large scale models and datasets. High quality API design with an eye towards eval and data-driven techniques.
...
* Experience with Large Language Models (LLM), Vision Language Models (VLM), deep learning or reinforcement learning.
