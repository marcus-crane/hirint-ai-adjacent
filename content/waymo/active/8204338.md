---
title: 'Technical Program Manager - Onboard Systems, ML Modeling '
status: active
id: '8204338'
source: greenhouse
url: https://careers.withwaymo.com/jobs?gh_jid=8204338
lastmod: '2026-09-17T17:45:06-04:00'
date: '2026-09-17T16:49:09-04:00'
...
* Experience with large language models (LLMs), vision language models, generative AI, diffusion models, large-scale model training, data labeling, data generation and packaging for model training
...
* Experience with model evaluation techniques, metrics, time-series analysis, and predictive modeling using sensor data, model optimization, and scaling techniques
