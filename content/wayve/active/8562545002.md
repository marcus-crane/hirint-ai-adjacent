...
As a Staff / Senior Machine Learning Engineer on Wayve’s Core Model Safety team in AV Core, you will help shape what our end-to-end driving model must understand to be safe and reliable in the real world - and turn that into trained capabilities, clear evidence, and adoption on the shared backbone across core and product engineering.
