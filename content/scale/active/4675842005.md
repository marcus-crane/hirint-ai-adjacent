---
title: Staff Product Manager, Gen AI
status: active
id: '4675842005'
source: greenhouse
url: https://job-boards.greenhouse.io/scaleai/jobs/4675842005
lastmod: '2026-09-01T12:25:49-04:00'
date: '2026-03-23T10:54:30-04:00'
...
* These roles are deeply cross-functional. You will work with dedicated engineering, design, ML research and data science teams, as well as operations, finance, growth, and customer-facing stakeholders. The problems are technically complex, the pace is fast, and the impact is measurable.
...
* Scale is a growth-stage company with the resources of a well-funded leader and the urgency of a startup. PMs here operate with significant autonomy, ship frequently, and are expected to be deeply analytical and hands-on. **PMs move fast, understand the technical details within their area (detail oriented), and are AI power users** to accelerate and increase their impact.

Example Product Management Openings:

* **Growth PM: Contributor Engagement & Retention (Supply Side)** — Own how 500,000+ contributors across 100+ countries build skills, stay engaged, and grow on Scale’s platform. You will define the engagement and retention strategy for our global contributor marketplace — engagement loops, skill progression, and re-engagement at global scale — and the metrics that prove it: activation, long-term retention, and churn. This role sits at the heart of supply health, the input every frontier model we train depends on. This is a highly cross-functional role working with our Growth Ops partners who are in the field with our contributors. And our strategy changes as our supply constrained skills change.
