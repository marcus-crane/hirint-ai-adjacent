...
lastmod: '2026-08-27T13:25:25-04:00'
date: '2026-08-26T12:11:18-04:00'
...
We're looking for designers who ship fast and stay in motion—people who would rather get something in front of users this week than perfect it for a month, and then spend then next months perfecting it. You're excited to question fundamental UI assumptions and invent patterns that feel native to AI, and you're already using tools like Claude Code to extend what you can build. You pay attention to where model capabilities are heading, not just what Claude can do today, and you find ways to keep caring about the pixels, the copy, and the edge cases while shipping quickly.

Read more [here](https://x.com/claudeai) for the type of features we build.

## **Key responsibilities**

* Collaborate with product managers, engineers, AI researchers and other stakeholders to define product vision, strategy and roadmaps, and play an active role in shipping.
* Understand the technical architecture of our products and define primitives for new capabilities.
...
* Comfortable in code, design, prototypes, and learning new ways to communicate ideas and concepts
...
* Experience designing and shipping complex workflows, enterprise/B2B SaaS, developer tools, or API products end-to-end
...
Specific projects and responsibilities depend on team staffing, which we'll discuss once we've seen more of your work and understood your strengths and interests. A few examples across teams:

* **Core Apps:** Pioneer new ways for Claude to be a true partner in people's day to day lives. Build industry-leading tools for coding, work, design and more, shaping the way people leverage AI at work in transformative ways.
...
* **Enterprise & Verticals:** Shape how teams work with and bring Claude to their entire workforce. You'll turn the messy reality of knowledge work (research, analysis, writing, decisions across a dozen tools) into experiences where Claude is a true collaborator, backed by the admin and governance controls that let an org to use AI to the fullest.
