...
lastmod: '2026-09-18T03:03:59-04:00'
...
Applications are now open for our January cohort - [apply here.](https://bit.ly/afpsafety)
...
Applications and interviews are managed by [Constellation](https://www.constellation.org/), our recruiting and program partner. Constellation also runs the Berkeley workspace and provides program support for fellows working on AI safety and security; fellows on capabilities-focused projects are supported directly by Anthropic. All applicants currently use the same application portal but we are working to separate applications for safety/security and capabilities-focused projects in future rounds.
