...
lastmod: '2026-04-20T19:28:44-04:00'
...
* Financial Services — analysts and bankers building models, memos, and decks under deadline. We're building retrieval, analysis, and document generation that holds up to executive review.
* Healthcare — clinical documentation, prior auth, and care coordination. Work where accuracy isn't a feature, it's the whole product — and where compliance is part of the engineering.
* Legal — contract analysis, document review, and matter management for teams that will read every word we generate and know immediately if it's wrong.
