...
id: '5430869008'
source: greenhouse
url: https://job-boards.greenhouse.io/anthropic/jobs/5430869008
lastmod: '2026-09-22T02:55:09-04:00'
date: '2026-09-22T02:54:32-04:00'
...
* Serve as the primary technical advisor to enterprise customers in Korea throughout their Claude adoption journey, from discovery to initial evaluation through deployment. You will need to coordinate internally across multiple teams and stakeholders, including global teams across time zones, to drive customer success
* Support customers building with both the Claude API and Claude for Work
* Create and deliver compelling technical content tailored to different audiences. You will need to be able to span the gamut from technical deep dives for engineering and development teams up to business value focused conversations with executives
...
* Help customers develop evaluation frameworks to measure Claude's performance for their specific use cases, including Korean language use cases
...
* 5+ years of experience in people management for the technical sales roles.
* Experience working with enterprise customers, navigating complex buying cycles involving multiple stakeholders
* Exceptional ability to build relationships with and communicate technical concepts to diverse stakeholders, including C-suite executives, engineering and IT teams, and more
