---
title: 'Manager, Customer Success - Commercial '
status: active
id: '5422436008'
source: greenhouse
url: https://job-boards.greenhouse.io/anthropic/jobs/5422436008
lastmod: '2026-09-15T14:18:44-04:00'
date: '2026-09-15T14:18:44-04:00'
...
As Manager, Customer Success – Commercial, you'll lead the Customer Success Managers who cover our Commercial accounts: high-growth mid-market technology companies (including cybersecurity and fintech), mid-market organizations in industries such as financial services, healthcare, legal and professional services, private equity-backed portfolio companies, and a high-volume SMB book, all building on Claude across API, Claude Code, Cowork and other surfaces. You'll directly coach and develop a team of ~5 CSMs, develop scalable motions to support the broader portfolio, while keeping strategic oversight of the highest-impact engagements in the segment. This role demands exceptional people leadership combined with deep product knowledge and customer success acumen to guide your team in maximizing customer value, driving consumption, and expanding our footprint across commercial accounts. You'll be instrumental in building scalable CS processes, methodologies, and playbooks that will define how we grow and mature as an organization.

**Responsibilities:**

* Directly manage and develop a team of ~5 Customer Success Managers supporting strategic mid-market, PE-backed and SMB accounts across all Anthropic products (API, Claude Cowork, Claude Code)
* Build scalable and agentic success strategies and motions to accelerate consumption, expansion and value realization across the whole commercial portfolio
...
* Join strategic customer engagements and escalations, demonstrating executive presence with founders, C-level and functional leaders at high-growth mid-market and PE-backed companies
* Build and refine scalable CS processes including success planning frameworks, QBR templates, and expansion playbooks
* Partner closely with Sales and Applied AI to identify expansion opportunities, facilitate smooth handoffs, and ensure aligned account strategies
...
* 7+ years of experience in customer success, account management, or customer-facing roles, with 3+ years of front-line management experience
* Proven track record of managing and building customer success teams in SaaS, API, or AI/ML companies
* Experience managing large customer portfolios at commercial scale (mid-market, SMB and PE-backed companies), including a high volume of accounts ranging from ~$100K to $10M+ in annual spend
* Strong understanding of consumption-based business models, with proven ability to drive adoption, expansion, and value realization across different pricing structures
