---
title: Manager, Startup Partnerships
status: active
id: '5229558008'
source: greenhouse
url: https://job-boards.greenhouse.io/anthropic/jobs/5229558008
lastmod: '2026-06-12T17:11:42-04:00'
date: '2026-06-12T17:11:42-04:00'
...
* Work with partners to establish Claude as the AI platform of choice across global startup markets
* Create a framework and plan for scaled initiatives to help ensure early stage founders are choosing to build on Claude.
* Support the initiation and development of strategic relationships with global and regional partners
* Adapt partnership models and GTM approaches to local market dynamics, regulatory environments, and cultural nuances
* Navigate complex environments including regulatory, compliance, and data sovereignty considerations

## **You may be a good fit if you have:**

* 12+ years experience building and scaling partner ecosystems across multiple international geographies with demonstrable evidence of driving substantial revenue and P&L management
* 5+ years management experience leading and scaling high-performing partnership teams
* Deep experience operating across multiple geographies with understanding of local business practices, cultural nuances, and market dynamics
* Strong background in enterprise technology sales internationally, ideally within cloud, AI/ML, or platform businesses
* Executive presence with the ability to influence and build relationships at C-suite level across diverse cultures
* Collaborative approach with ability to work cross-functionally across sales, product, marketing, and regional teams
* Experience specifically within AI/ML or frontier technology companies
* Established relationships with major global VCs, accelerators, and startup ecosystems (YC, a16z, Sequoia, etc.)
