...
We are looking for an Frontier AI Risks Lead to help us understand potential harms and misuse of AI in a time of rapid, sustained change. We seek to understand how developments in AI could intersect with misuse and abuse accelerating existing harm areas and creating novel risks. We seek to scan available signals and use strategic foresight methodologies to enable proactive detection and mitigation of frontier AI risks.

In this role, you will help to provide strategic-level perspective on a range of frontier AI risk areas, helping to produce actionable understanding of safety issues relevant to OpenAI’s platforms, surfaces, and broader business interests. Utilizing mixed quantitative and qualitative methodologies, you will spot early warning signs, pull threads on potentially concerning behavior, and turn weak signals into clear, prioritized risk calls. You will focus on upstream ecosystem scanning, competitive benchmarking, and external narrative/risk sense-making. Your work will help to inform cross-functional partners in the research, protection and safety stacks to guide mitigations that keep users, brands, and communities safe while allowing productive, creative uses of these tools to thrive and benefit all of humanity.
...
* Build early warning and measurement capabilities
  ...
  + Help define the core metrics and signals that indicate whether fast-evolving AI environments are safe (e.g., misalignment, interpretability, recursive self-improvement, societal and systemic risks, etc.).
...
* Provide strategic analysis and future-looking perspectives
  ...
  + Run scenario analyses that explore how frontier AI risks might evolve over the next 6–24 months (e.g., how multi-agent misalignment could manifest in unexpected ways when introduced into important economic sectors).
...
* Significant experience (typically 5+ years) in AI research, trust and safety, integrity, security, policy analysis, or intelligence work focused on a range of frontier AI risks situated in strategic context and translated into actionable intelligence.
