...
You will be a core contributor on the Developer Productivity team, designing and building the systems, tools, and workflows that make every SpaceXAI developer incredibly productive.

Your mission is to create a world-class developer experience inside SpaceXAI: fast builds, intuitive tooling, reliable environments, and seamless CI/CD. You’ll architect, implement, and operate the foundations that power our engineering organization—from local development to global deployments.

You’ll set technical direction within the team, write and review code, and collaborate across engineering to make it effortless for developers to build, test, and ship quickly. Excellence means SpaceXAI engineers feel like they’re working in the best development environment in the world—one so good that parts of it could eventually become external features of Cursor itself.
