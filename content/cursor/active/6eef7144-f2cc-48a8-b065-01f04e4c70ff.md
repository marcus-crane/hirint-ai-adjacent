...
status: active
id: 6eef7144-f2cc-48a8-b065-01f04e4c70ff
source: ashby
url: https://jobs.ashbyhq.com/cursor/6eef7144-f2cc-48a8-b065-01f04e4c70ff
lastmod: '2026-06-28T21:38:56.671+00:00'
date: '2026-06-28T21:38:56.671+00:00'
...
As a Software Engineer, Services Platform at SpaceXAI, you'll build the platform-level primitives that make it hard for product teams to build brittle systems and easy to build resilient ones.

SpaceXAI is scaling fast, hundreds of engineers shipping to millions of developers, and your core focus will be the abstractions that make that sustainable: service provisioning, deploy tooling, workflow orchestration, and defining what it means to own and operate a service at SpaceXAI. You'll work at the intersection of developer experience and production reliability, building the golden pathways that every engineering team runs on.
...
Defining the contract for service ownership: what it means to own a service, how services integrate with SpaceXAI's infrastructure abstractions, and building the service catalogue so incidents get resolved in minutes, not hours.
