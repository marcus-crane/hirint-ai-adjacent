...
* Guide the next generation of [**CursorBench**](https://cursor.com/blog/cursorbench) so it continues to reflect real developer workflows at SpaceXAI, and expand it with new evals that measure other properties developers value.
