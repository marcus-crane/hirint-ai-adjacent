...
As a Software Engineer on the **Agent Harness** team at SpaceXAI, you’ll build the core agent behavior and capabilities that power agent experiences across Cursor products. This spans agent orchestration, tools, guardrails, and model behavior tuning—designed as a platform that SpaceXAI engineers can extend and depend on.
