...
加入 DeepSeek Harness 团队，探索面向下一代 Agent Harness 的工程难题。
...
你将加入 Harness 团队，与工程师、研究员、产品经理紧密协作，参与 DeepSeek 出品的 Agent 产品研发的全过程，定义 DeepSeek 对 Harness 的理解。
