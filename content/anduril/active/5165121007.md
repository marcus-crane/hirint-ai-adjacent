...
lastmod: '2026-08-13T14:28:30-04:00'
...
Anduril’s Demand & Supply Planning team is seeking a world-class Senior Material Planner to join our Fury Launch team at Arsenal-1 in Ashville, OH. The Senior Material Planner has an integral role at Anduril, having material flow responsibility throughout the entire value chain, from raw materials to finished goods shipped to customers. They will have full ownership of certain assemblies and product lines, and will be ultimately responsible for sending the correct signals to Purchasing and Manufacturing on what and when to buy or build. This hire will be instrumental in signaling and forecasting accurate demand, planning inventory levels, and ensuring that Anduril supports its hardware requirements via Enterprise Resource Planning (ERP) software and other associated tools.
