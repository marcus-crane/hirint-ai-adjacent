...
You will be the L10 System Validation Engineer, defining what it means for the accelerator platform to be production-ready. You'll be responsible for building our Cluster Scale Memory subsystem and build the infrastructure to prove it. You'll personally drive the most critical issues from detection through root cause to verified fix.
