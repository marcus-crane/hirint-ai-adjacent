...
* Directly manage and develop team leads and senior engineers with a variety of experience levels
* Drive low-level control-plane software for system bring-up, provisioning, networking, configuration, and fleet management
...
* Establish system telemetry and observability infrastructure for customers and in-house operations
...
* 8+ years of experience in system software, infrastructure, or large-scale compute systems, including 3+ years leading engineering teams
...
* Experience designing observability systems for complex compute environments, supporting both internal engineering operations and customer deployments.
* Experience building pipelines for high-volume, heterogeneous telemetry and unstructured logs, including storage, retention, and querying.
* Experience developing analysis tools that turn system data into actionable insights for debugging, performance optimization, and reliability.
