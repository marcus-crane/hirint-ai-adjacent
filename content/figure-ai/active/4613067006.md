...
lastmod: '2026-06-23T18:02:51-04:00'
date: '2025-10-24T17:51:10-04:00'
...
* Design and build custom scalable test stations to perform functional, performance, and reliability testing on key robotic sub-assemblies.
* Develop mechanical and electrical systems incorporating diverse hardware components including, DAQ, communication modules, actuators, and sensors.
...
* Generate detailed electrical schematic drawings and wiring diagram documentation.
...
* Conduct test-station bring-up and qualification to ensure system robustness, and drive setup improvements to meet testing and data-capture requirements.
...
* A genuine passion for robotics and hardware development.

**Bonus Qualifications:**

1. Proficiency in CAD software for mechanical and electrical design. (CATIA V6 experience)
2. Familiarity with rapid prototyping (3D printing, circuit design)
3. Familiarity with manufacturing processes and first article inspection
4. Familiarity with test station qualification process
5. Experience with sensors, motors, or electromechanical systems
6. Familiarity with Linux
